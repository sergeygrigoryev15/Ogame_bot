...
class ResourcesTab(WebElement):
    ...
    def __init__(self):
        ...
        self.resource_value_template = self.resource_container_template + \
    ...
    def get_main_resource_info(self, resource: Resources):
        ...
        data.update({'dig_velocity': int(dig_velocity.get_int()),
    ...
    def get_dark_matter_info(self):
        ...
        data.update({'bought': int(bought.get_int()),
                     'found': int(found.get_int())})
        return data
    ...
    def get_energy_info(self):
        ...
        data.update({'produced': int(produced.get_int()),
                     'used': int(used.get_int())})
        return data
